...
const productos = [
  ...
  new Producto(4, "Born to Spend Camuflage", "./Assets/JC Hats/Born to Spend Camuflage/FullSizeRender-_7_-transformed.webp"),
  new Producto(7, "SPEND MONEY GREEN", "./Assets/JC Hats/Spend Money Green/FullSizeRender-_11_-transformed.webp"),
  new Producto(6, "Born to Spend Negra c Rojo", "./Assets/JC Hats/Born to Spend Negra c Rojo/FullSizeRender-_12_-transformed.webp"),
  new Producto(8, "SPEND MONEY GRAY BLUE", "./Assets/JC Hats/Spend Money Gray Blue/FullSizeRender_(1)-transformed.webp"),
  new Producto(5, "Born to Spend Malla Negra", "./Assets/JC Hats/Born to Spend Malla Negra/FullSizeRender-_13_-transformed.webp"),
