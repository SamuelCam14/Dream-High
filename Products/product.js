...
const productos = [
  ...
  },
  {
    ...
    "precio": "$1,100.00",
    "descripcion": "Introduce nuestra gorra 'Tumbados Club', una pieza única que fusiona el estilo tumbado con un toque de lujo y originalidad. Esta gorra negra con detalles en rojo es perfecta para aquellos que buscan expresar su personalidad.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$1,100.00",
    "descripcion": "Presentamos nuestra gorra 'LA Clover', una pieza única que combina elegancia y extravagancia. Con su diseño negro y detalles brillantes, esta gorra es perfecta para quienes buscan destacar en su estilo.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$1,100.00",
    "descripcion": "Presenta nuestra gorra exclusiva 'Clover Red', una pieza de edición limitada que combina estilo urbano con un diseño audaz. Esta gorra destaca por su llamativo color rojo y su bordado distintivo.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$1,200.00",
    "descripcion": "Descubre nuestra exclusiva gorra de edición limitada All Eyez on Me, diseñada para quienes buscan destacar con estilo y personalidad. Esta gorra única combina materiales de alta calidad y detalles cuidadosamente elaborados para ofrecerte una pieza verdaderamente especial.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$1,100.00",
    "descripcion": "Descubre nuestra gorra 'From Clover with Love', una pieza elegante que fusiona el estilo clásico con un toque moderno. Este diseño en negro profundo con bordado blanco es perfecto para aquellos que aprecian la sutileza y la sofisticación en su vestimenta.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "Hecha de algodón, bordado 3D y el logo lateral con micro bordado. En la visera tiene logos con relieve y un llamativo color morado.",
    "infoAdicional": [
      "Marca: High Stakes.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "¿Estás listo para apostar por el éxito? La gorra RISK RICH es para aquellos que se atreven a jugar en las grandes ligas. Fabricada con una elegante visera de gamuza, esta gorra es una declaración de estilo y ambición.",
    "infoAdicional": [
      "Marca: High Stake.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "A veces arriba, a veces abajo. La gorra Bipolar esta hecha de gamuza, bordado 3D enfrente y micro bordado en el lateral, abajo tiene diseño con relieve y es en general un diseño muy flexible.",
    "infoAdicional": [
      "Marca: High Stakes.",
  ...
  },
  {
    ...
    "precio": "$900.00",
    "descripcion": "Introduce nuestra gorra 'Corridos Tumbados', una pieza única que fusiona lo tumbado con la exclusividad de la marca.",
    "infoAdicional": [
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "Haciendo honor al WESTSIDE. Hecha de gamuza, con bordado 3D en el frente y micro bordado en el lateral. Debajo de la visera tiene diseño impreso de un pañuelo. Con un estilo callejero pero fino.",
    "infoAdicional": [
      "Marca: High Stakes.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "Haciendo honor al WESTSIDE. Hecha de gamuza, con bordado 3D en el frente y micro bordado en el lateral. Debajo de la visera tiene diseño impreso de un pañuelo. Con un estilo callejero pero fino. Llévatela en negro y/o café, no hay fallas.",
    "infoAdicional": [
      "Marca: High Stakes.",
      "Colores disponibles: Negro.",
      "Modelo: All Eyez On Me"
  ...
  },
  {
    ...
    "imagen": "../Assets/JC Hats/Spend Money Beige Green/FullSizeRender-_10_.webp",
    "precio": "$800.00",
    "descripcion": "La colección de Spend Money forma parte de la nueva línea de diseño que lleva JC Hats, la cual consta de enfocarnos más hacia la moda (reflejándose en el cambio de materiales y uso de colores nuevos) pero siempre manteniendo la esencia de la marca del lujo y la diversión (a través de frases utilizadas en los diseños frontales).",
    "infoAdicional": [
      "Marca: JC Hats.",
  ...
  },
  {
    ...
    "imagen": "../Assets/JC Hats/Born to Spend Malla Negra/FullSizeRender-_13_.webp",
    "precio": "$800.00",
    "descripcion": "Una gorra negra con malla para mayor ventilación y comodidad. Diseño elegante con detalles bordados.",
    "infoAdicional": [
      "Marca: JC Hats.",
      "Colores disponibles: Negro.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "La clásica pantera negra. Hecha de poliéster y con malla en la parte de atrás. Tiene parche de PVC y diseño con relieve en la parte de abajo de la visera. 🐾",
    "infoAdicional": [
      "Marca: High Stakes.",
      "Colores disponibles: Negro.",
  ...
  },
  {
    ...
    "precio": "$800.00",
    "descripcion": "Completa tu outfit y sube de nivel tu estilo con esta gorra New Era de Los Angeles Dodgers y lleva a tu equipo siempre contigo. Sus materiales y forma única hacen de esta colección la mejor elección. No te quedes sin la tuya.",
    "infoAdicional": [
      "Marca: New Era.",
      "Colores disponibles: Azul.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "Completa tu outfit y sube de nivel tu estilo con esta gorra New Era de New York Yankees y lleva a tu equipo siempre contigo. Sus materiales y forma única hacen de esta colección la mejor elección. No te quedes sin la tuya.",
    "infoAdicional": [
      "Marca: New Era.",
      "Colores disponibles: Rojo.",
  ...
  },
  {
    ...
    "precio": "$800.00",
    "descripcion": "La colección Black on Black de los New York Yankees esta diseñada en color negro para lucir elegante y con más estilo que nunca. ¿Quieres una gorra única? Esta 59FIFTY es la indicada, siempre se ve bien y combina con todo. Agrégala a carrito ahora.",
    "infoAdicional": [
      "Marca: New Era.",
      "Colores disponibles: Negro.",
  ...
  },
  {
    ...
    "precio": "$850.00",
    "descripcion": "Esta gorra New Era 59FIFTY de Texas Rangers Authentic Collection presenta el logotipo de los Rangers bordado en los paneles frontales, el MLB Batterman al reverso y el flag de New Era bordado en el lado izquierdo. Luce como tus peloteros favoritos y apoya a tu equipo con la gorra oficial de la MLB.",
    "infoAdicional": [
      "Marca: New Era.",
      "Colores disponibles: Rojo.",
